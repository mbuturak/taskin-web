...
export default function CraneLoadTestPage() {
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Crane Load Test Service",
    "name": "Crane Load Test",
    "description": "Dynamic load tests of cargo cranes, accommodation ladders, embarkation ladders, cargo hold hatches and other lifting appliances up to 1200 tons with fully IACS approved water bags / dynamometer and shackles.",
    "provider": {
      "@type": "Organization",
    ...
    "availableChannel": {
      "@type": "ServiceChannel",
      "serviceUrl": `${siteUrl}/crane-load-test`
    }
  };

  const images = [
    { src: "/main-assets/image/crane-load.jpeg", alt: "Crane load test service IACS approved" },
    { src: "/main-assets/image/crane-3.jpg", alt: "Marine crane load testing up to 1200 tons" },
    { src: "/main-assets/image/crane-4.jpg", alt: "Cargo crane dynamic load test" },
    { src: "/main-assets/image/crane-5.jpg", alt: "Accommodation ladder load test" },
    { src: "/main-assets/image/crane-6.jpg", alt: "Lifting appliance load test service" }
  ];
  ...
  return (
    <>
      ...
      />
      <HeaderFour />
      <Breadcumb title="CRANE LOAD TEST" bgImage="/main-assets/image/services-bg.jpg" />
        ...
        <div className="container" style={{ marginTop: '50px', marginBottom: '50px' }}>
          <div className="row">
            <div className="col-12">
              <h1 className="sec-title mb-4">Crane Load Test</h1>
              <p className="mb-4" style={{ fontSize: '18px', lineHeight: '1.8' }}>
                Task-in Services provides IACS approved crane load testing services for marine vessels.
